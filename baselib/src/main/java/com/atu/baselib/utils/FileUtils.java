...
public class FileUtils {
	...
	public static String getCachePath(Context context)
	{
		...
		if (sdCardExist)
		{
			sdDir = context.getExternalCacheDir().getPath();
		}
		else {
    ...
    */
	...
	public static Uri getUriForFile(Context context, File file){
		Uri uri = FileProvider.getUriForFile(context, "com.hhkc.gaodeditu.fileprovider",file);
		return uri;
	}
