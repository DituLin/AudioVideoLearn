...
Java_com_atu_ffmpeglive_ffmpeg_FFmpegHandle_initVideo(JNIEnv *env, jobject instance,
                                                          jstring url_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_atu_ffmpeglive_ffmpeg_FFmpegHandle_onFrameCallback(JNIEnv *env, jobject instance,
                                                                jbyteArray buffer_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_atu_ffmpeglive_ffmpeg_FFmpegHandle_close(JNIEnv *env, jobject instance) {
    if (video_st)
