...
Java_com_atu_ffmpegvoice_MainActivity_addBgMusic(
        JNIEnv *env,
    ...
    const char *out_filename = "/storage/emulated/0/Atu/video/bgMusic.mp4";//Output file URL
    av_register_all();
    //Input
...
jstring
Java_com_atu_ffmpegvoice_MainActivity_avcodecinfo(
        JNIEnv *env, jobject) {
    char info[40000] = {0};
